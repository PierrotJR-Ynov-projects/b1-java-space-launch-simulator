...
Artemis est un simulateur de lancement spatial, réalisé dans le cadre d'un projet scolaire. Différents choix sont permis (lanceurs, capsules ou boosters) avec un choix varié de missions. 
